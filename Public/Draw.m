...
%--------------------------------------------------------------------------
    ...
    if nargin < 2
        if M == 2
            varargin = {'ok','MarkerSize',Size(1),'Marker','o','Markerfacecolor',[0 0 1],'Markeredgecolor',[0 0 1]};
        elseif M == 3
            varargin = {'ok','MarkerSize',Size(2),'Marker','o','Markerfacecolor',[0 0 1],'Markeredgecolor',[0 0 1]};
        elseif M > 3
